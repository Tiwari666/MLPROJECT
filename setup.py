...
setup(
    ...
    description='A small machine learning project',  # A short description of the project
    ...
    url='http://github.com/Tiwari666/my_ml_project',  # Link to the project's GitHub repo
    ...
    python_requires='>=3.12',  # Minimum version of Python required for the project
    classifiers=[
    ...
    keywords='machine learning, data science, pandas',  # Keywords to find the project
